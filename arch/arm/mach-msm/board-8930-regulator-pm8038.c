...
/* Regulators for 8930 QRD SGLTE EVT */
	...
	REGULATOR_SUPPLY("bma_vreg",		"12-0018"),
	REGULATOR_SUPPLY("bmm_vreg",		"12-0010"),
	REGULATOR_SUPPLY("cm36283_vdd",		"12-0060"),
};
VREG_CONSUMERS(L10) = {
...
/* FIH-SW-MM-VH-DISPLAY-NICKI-00+ */
	REGULATOR_SUPPLY("lcd_iovdd",		"mipi_dsi.1"),
};
VREG_CONSUMERS(L19) = {
...
/* FIH-SW-MM-VH-DISPLAY-NICKI-05+ */
	REGULATOR_SUPPLY("lcd_lvs2",		"mipi_dsi.1"),
};
...
msm8930_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_LDO(L1,	 0, 1, 0, 1300000, 1300000, "8038_s2", 0, 0),	/*VREG_L1_V1P3*/
	RPM_LDO(L2,	 0, 1, 0, 1200000, 1200000, "8038_s2", 0, 0),	/*VREG_L2_V1P2*/
	RPM_LDO(L3,	 0, 1, 0, 3075000, 3075000, NULL,      0, 0),	/*VREG_L3_V3P075*/
	RPM_LDO(L4,	 1, 1, 0, 1800000, 1800000, NULL,      10000, 10000),	/*VREG_L4_V1P8*/
	RPM_LDO(L5,	 0, 1, 0, 2950000, 2950000, NULL,      0, 0),	/*VREG_EMMC_V2P95*/
	RPM_LDO(L6,	 0, 1, 0, 2950000, 2950000, NULL,      0, 0),	/*VREG_SD_V2P95*/
